...
*/
	...
	Function SendAPIRequest($url, $method, $parameters, $oauth, $options, &$response)
	{
		...
		$http = new \App\Libraries\Microsoft\http_class();
	...
	Function Initialize()
	{
		switch($this->server)
		{
			...
			case 'Microsoft':
				...
				$this->dialog_url = 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id={CLIENT_ID}&response_type=code&redirect_uri={REDIRECT_URI}&state={STATE}&scope={SCOPE}';
				$this->append_state_to_redirect_uri = '';
				$this->access_token_url = 'https://login.microsoftonline.com/f4054165-5313-44d6-9347-6498b14cf135/oauth2/v2.0/token';//'https://login.live.com/oauth20_token.srf';
				$this->authorization_header = true;
				$this->url_parameters = false;
				break;
