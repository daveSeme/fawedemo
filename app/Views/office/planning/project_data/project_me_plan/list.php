...
echo base_url() . "/planning/project_me_plan/select_list";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("planning/project_me_plan/delete/" . $record["id"]);
