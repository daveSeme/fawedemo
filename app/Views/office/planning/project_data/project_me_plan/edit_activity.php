...
echo "                      </td>\r\n                      \r\n                    </tr>\r\n                  </tbody>\r\n                </table>\r\n                ";
$insert_url = "planning/project_me_plan/edit_activity/" . $workflow_id . "/?output_id=" . $request->getVar("output_id");
...
echo "</div>\r\n                  </div>\r\n\r\n\r\n\t\t\t\t<!-- Form Starts here  --> \r\n                \r\n                    <div class=\"col-1 mb-3 mt-3\">\r\n                    <label class=\"form-label\" for=\"name\">Activity Type <span class=\"text-danger\">*</span></label>\r\n                    </div>\r\n                    <div class=\"col-6 mb-3 mt-3\">\r\n                    \t<input type=\"radio\" name=\"activity_type\" id=\"activity_type\" value=\"Non-Budget Activity\" required=\"required\" ";
if ($form_data["activity_type"] == "Non-Budget Activity") {
    echo "checked=\"checked\"";
}
echo "/>&nbsp;Non-Budget Activity &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n                    \t<input type=\"radio\" name=\"activity_type\" id=\"activity_type\" value=\"Budget Activity\" required=\"required\" ";
if ($form_data["activity_type"] == "Budget Activity") {
    echo "checked=\"checked\"";
}
...
foreach ($results as $row_so) {
    ...
    echo $row_so["id"];
    echo "\" ";
    $row_so["id"] = $form_data["activity_name"];
    if ($row_so["id"]) {
...
echo $form_data["activity_code"];
echo "\">\r\n                    <div class=\"invalid-feedback\"> Please enter activity code. </div>\r\n                  </div>\r\n                  \r\n                  \r\n                  \r\n\t\t\t\t";
$db = Config\Database::connect();
$query = $db->query("select * from project_activity_annual_budget_map where activity_id = \"" . $form_data["id"] . "\"");
...
foreach ($results as $row) {
    $year[] = $row["year"];
    $annual_plan[$row["year"]] = $row["annual_plan"];
    $annul_budget[$row["year"]] = $row["annul_budget"];
}
