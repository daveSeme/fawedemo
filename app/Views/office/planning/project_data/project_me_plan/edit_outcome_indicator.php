...
echo "                      </td>\r\n                    </tr>\r\n                   \r\n                  </tbody>\r\n                </table>\r\n                \r\n                ";
$insert_url = "planning/project_me_plan/edit_outcome_indicator/" . $workflow_id . "/?outcome_id=" . $request->getVar("outcome_id");
...
$db = Config\Database::connect();
$query = $db->query("SELECT * FROM project_outcome_indicator_target where indicator_id= \"" . $form_data["id"] . "\"");
$results = $query->getResultArray();
$year = [];
$target = [];
foreach ($results as $row) {
