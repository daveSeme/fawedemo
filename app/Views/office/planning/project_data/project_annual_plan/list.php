...
echo "            <!-- datatable start -->\r\n            <table id=\"dt-basic-example\" class=\"table table-bordered table-striped w-100\">\r\n              <thead class=\"bg-primary-600\">\r\n              \r\n                <tr>\r\n                  \r\n                  <th>Project </th>\r\n                  <th>Period </th>\r\n\t\t\t\t  <th width=\"20%\">Action</th>\r\n                </tr>\r\n                \r\n              </thead>\r\n              \r\n              <tbody>\r\n              ";
if ($data) {
    echo "          ";
    foreach ($data as $record) {
        echo "  <tr>\r\n                \r\n                  <td>\r\n                  ";
        $project_details = get_by_id("id", $record["project"], "project");
        echo $project_details["name"];
        echo "                  </td>\r\n                  \r\n                  \r\n                  <td>";
        echo ucfirst($record["year"]);
        echo "</td>\r\n                    <td>\r\n                   <div class=\"d-flex demo\"> \r\n                    \r\n\t\t\t\t   \r\n\t\t\t\t    <a href=\"#\"  onClick=\"javascript:del_rec_1('";
        echo base_url("planning/project_annual_plan/delete/" . $record["id"]);
        ...
        echo base_url("planning/project_annual_plan/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\t\r\n\t\t\t\t   \r\n                    <a href=\"";
        echo base_url() . "/planning/project_annual_plan/read/" . $record["id"];
