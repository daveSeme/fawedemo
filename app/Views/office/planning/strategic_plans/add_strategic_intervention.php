...
$insert_url = "planning/strategic_plans/add_strategic_intervention/" . $fydp . "/?objective_id=" . $request->getVar("objective_id");
...
echo set_value("strat_interven_name");
...
echo set_value("strat_interven_category");
