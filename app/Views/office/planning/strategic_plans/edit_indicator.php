...
$insert_url = "planning/strategic_plans/edit_indicator/" . $fydp . "/?intervention_id=" . $request->getVar("intervention_id");
...
echo $form_data["id"];
echo "\">\r\n\r\n\r\n\t\t\t\t<!-- Form Starts here  --> \r\n                \r\n                  <div class=\"col-12 mb-3 mt-5\">\r\n                    <label class=\"form-label\" for=\"name\">Intervention Indicator <span class=\"text-danger\">*</span></label>\r\n                    <input type=\"text\" name=\"indicator\" class=\"form-control\" id=\"indicator\" placeholder=\"Please enter Intervention Indicator\" value=\"";
