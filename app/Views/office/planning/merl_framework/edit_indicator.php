...
$insert_url = "planning/merl_framework/edit_indicator/" . $fydp . "/?intervention_id=" . $request->getVar("intervention_id");
...
echo $form_data["id"];
echo "\">\r\n\r\n\r\n\t\t\t\t<!-- Form Starts here  --> \r\n                \r\n                  <div class=\"col-12 mb-3 mt-5\">\r\n                    <label class=\"form-label\" for=\"name\">Intervention Indicator <span class=\"text-danger\">*</span></label>\r\n                    <input type=\"text\" name=\"indicator\" class=\"form-control\" id=\"indicator\" value=\"";
echo $form_data["indicator"];
echo "\" required readonly=\"readonly\">\r\n                    <div class=\"invalid-feedback\"> Please enter Intervention Indicator</div>\r\n                  </div>\r\n                  \r\n                  \r\n                    <div class=\"col-12 mb-3\">\r\n                    <label class=\"form-label\" for=\"indicator_category\"> Indicator Category <span class=\"text-danger\">*</span></label>\r\n                    <select name=\"indicator_category\" id=\"indicator_category\" class=\"custom-select  \" required>\r\n                        <option value=\"Quantitative\"  ";
...
echo "                \r\n                \r\n                ";
$db = Config\Database::connect();
$query_check = $db->query("SELECT * FROM objective_indicator_target where indicator_id= \"" . $form_data["id"] . "\"");
...
if (empty($row_check)) {
    ...
    echo "                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                ";
    $db = Config\Database::connect();
    $query = $db->query("SELECT * FROM org_intervention_indicator_target where indicator_id= \"" . $form_data["id"] . "\"");
    $results = $query->getResultArray();
    $year = [];
    $target = [];
    foreach ($results as $row) {
...
echo base_url() . "/planning/merl_framework/edit/" . $fydp;
