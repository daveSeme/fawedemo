...
$insert_url = "planning/merl_framework/edit_objective_indicator/" . $fydp . "/?objective_id=" . $request->getVar("objective_id");
...
if (empty($row_check)) {
    ...
    echo "                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                \r\n                ";
    $db = Config\Database::connect();
    $query = $db->query("SELECT * FROM objective_indicator_target where indicator_id= \"" . $form_data["id"] . "\"");
    $results = $query->getResultArray();
    $year = [];
    $target = [];
    foreach ($results as $row) {
