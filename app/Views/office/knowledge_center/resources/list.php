...
echo base_url() . "/knowledge_center/resources/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("knowledge_center/resources/delete/" . $record["id"]);
        ...
        echo base_url("knowledge_center/resources/edit/" . $record["id"]);
