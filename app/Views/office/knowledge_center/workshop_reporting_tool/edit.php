...
$insert_url = "knowledge_center/workshop_reporting_tool/edit/" . $stdata["id"];
...
$db = Config\Database::connect();
$query = $db->query("select * from workshop_reporting_targets where  project_id = '" . $stdata["project"] . "' and workflow_id = '" . $stdata["id"] . "'");
$results = $query->getResultArray();
...
foreach ($results_file as $row_file) {
    ...
    echo "</a>                          \r\n                          </td>\r\n                          <td>\r\n                           <a href=\"";
    echo base_url("knowledge_center/workshop_reporting_tool/delete_docs/" . $row_file["id"] . "/" . $stdata["id"]);
