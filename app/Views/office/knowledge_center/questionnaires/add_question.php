...
$insert_url = "knowledge_center/questionnaires/add_question/". $fydp ."";
...
if (set_value("type") == "Numeric") {
    echo "selected=\"selected\"";
}
echo ">Numeric Input</option>\r\n                      <option value=\"Text\" ";
if (set_value("type") == "Text") {
    echo "selected=\"selected\"";
}
...
echo base_url() . "/knowledge_center/questionnaires/logframe/". $fydp ."";
