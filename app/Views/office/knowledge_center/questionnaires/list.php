...
echo base_url() . "/knowledge_center/questionnaires/add_questionnaire";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("knowledge_center/questionnaires/delete_questionnaire/" . $record["id"] . "?toList=true");
        ...
        echo base_url("knowledge_center/questionnaires/edit_questionnaire/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\t\r\n\t\t\t\t   \r\n                   ";
        echo "<a href=\"";
        echo base_url() . "/knowledge_center/questionnaires/logframe/" . $record["id"];
        echo "\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"View Questions\"><i class=\"fal fa-eye\"></i></a>                  ";
        echo "<a href=\"";
        echo base_url() . "/knowledge_center/questionnaires/view/" . $record["id"];
        echo "\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"View Responses\"><i class=\"fal fa-search-plus\"></i></a>                  ";
        echo " </div>                   </td>\r\n                </tr>\r\n                \r\n              \r\n                \r\n                \r\n                \r\n                 ";
    }
    echo "         ";
}
