...
echo "<div class=\"tree well\">\r\n              <ul role=\"tree\">\r\n                <li><strong>::Question::</strong> <a class=\"btn btn-primary btn-xs\" href=\"";
echo base_url() . "/knowledge_center/questionnaires/add_question/";
echo $fydp;
echo "\"><strong><font color=\"white\"> Add Question</font> </strong> </a>\r\n                </li>\r\n                \r\n\t\t\t\t";
$where = $fydp == null ? "" : " and questionnaire_id = ". $fydp ."";
$query = $db->query("select * FROM  mas_questions Where 1=1 " . $where . " order by id");
$g = 1;
...
foreach ($results as $row) {
    ...
    echo base_url() . "/knowledge_center/questionnaires/edit_question/" . $row["id"];
    ...
    echo base_url() . "/knowledge_center/questionnaires/delete_question/" . $row["id"];
