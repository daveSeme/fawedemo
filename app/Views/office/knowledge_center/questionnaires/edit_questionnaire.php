...
$insert_url = "knowledge_center/questionnaires/edit_questionnaire/" . $fydp;
...
echo changeDateFormat("d-m-Y", $form_data["startdate"]);
...
echo changeDateFormat("d-m-Y", $form_data["enddate"]);
