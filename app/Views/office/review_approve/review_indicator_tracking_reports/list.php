...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        if ($record["report_status"] == "2") {
            echo "                        \r\n                       <a href=\"";
            echo base_url() . "/review_approve/review_indicator_tracking_reports/review/" . $record["id"];
            echo "\" class=\"btn btn-primary\" title=\"Review Report\"><i class=\"fal fa-eye\"></i> Review</a>\r\n\r\n                       ";
        }
        echo "                       \r\n                            \r\n                       <a href=\"";
        echo base_url() . "/review_approve/review_indicator_tracking_reports/view/" . $record["id"];
