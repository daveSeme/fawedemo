...
echo " <strong>  " . $dis["name"] . "</strong> ";
echo " Dashboard</a> </li>\r\n\t  \r\n    </ul>\r\n    \r\n    \r\n    \r\n     \r\n    \r\n    \r\n<!--KPI Achieved Targer-->    \r\n<div class=\"tab-content border border-top-0 p-3\">\r\n      <div class=\"tab-pane fade show active\" id=\"tab_borders_icons-1\" role=\"tabpanel\">\r\n\t  \r\n\t  <div class=\"row\"> \r\n          \r\n          <!-------Start Row ---->\r\n          <div class=\"col-lg-12\">\r\n            <div id=\"panel-1\" class=\"panel\" data-panel-fullscreen=\"false\">\r\n              <div class=\"panel-hdr\">\r\n                <h2> Project Status by District</h2>\r\n              </div>\r\n              \r\n               <div class=\"row\"> \r\n                <div class=\"col-lg-12\">\r\n                    <div  id=\"container\"></div>\r\n                </div>\r\n                \r\n                \r\n                \r\n              </div>\r\n              \r\n              \r\n            </div>\r\n          </div>\r\n          <!-------Start Row ----> \r\n\t\t  \r\n\t\t  \r\n\t\t  <div class=\"col-lg-12\">\r\n            <div id=\"panel-1\" class=\"panel\" data-panel-fullscreen=\"false\">\r\n              <div class=\"panel-hdr\">\r\n                <h2>No of Project by District</h2>\r\n              </div>\r\n              \r\n               <div class=\"row\"> \r\n                <div class=\"col-lg-6\">\r\n                  <table class=\"highchart table table-bordered\" data-graph-container=\".. .. .highchart-kpi-achieved\"  data-graph-type=\"column\"  data-graph-datalabels-enabled=\"1\">\r\n                    \r\n                    <thead>\r\n                      <tr>\r\n                        <th bgcolor=\"#4189dd\">District</th>\r\n                        <th bgcolor=\"#4189dd\">Number of Projects</th>\r\n                      </tr>\r\n                    </thead>\r\n                    <tbody>\r\n\t\t\t\t\t\r\n                      ";
$query = $db->query("SELECT name, IFNULL(total,0) as total FROM mas_district left join (SELECT count(*) as total,district_id FROM project  left join project_map_district on project_map_district.project_id =project.id      group by district_id) as ongoing on ongoing.district_id=mas_district.id  where mas_district.id=\"" . $base_id . "\" ");
...
echo "\r\n                    </tbody>\r\n                  </table>\r\n                </div>\r\n                \r\n                \r\n                <div class=\"col-lg-6\">\r\n                  <div class=\"highchart-kpi-achieved\"></div>\r\n                </div>\r\n              </div>\r\n              \r\n              \r\n            </div>\r\n          </div>\r\n          \r\n        </div>\r\n\t  \r\n        <div class=\"row\"> \r\n          \r\n          <!-------Start Row ---->\r\n          <div class=\"col-lg-12\">\r\n            <div id=\"panel-1\" class=\"panel\" data-panel-fullscreen=\"false\">\r\n              <div class=\"panel-hdr\">\r\n                <h2> Summary of District by Budget</h2>\r\n              </div>\r\n              \r\n               <div class=\"row\"> \r\n                <div class=\"col-lg-6\">\r\n                  <table class=\"highchart table table-bordered\" data-graph-container=\".. .. .highchart-kpi-achieved\"  data-graph-type=\"column\"  data-graph-datalabels-enabled=\"1\">\r\n                    \r\n                    <thead>\r\n                      <tr>\r\n                        <th bgcolor=\"#4189dd\">District</th>\r\n                        <th bgcolor=\"#4189dd\">Budget</th>\r\n                      </tr>\r\n                    </thead>\r\n                    <tbody>\r\n\t\t\t\t\t\r\n                     ";
$query = $db->query("SELECT name, IFNULL(budget,0) as budget FROM mas_district left join (SELECT sum(budget) as budget,district_id FROM project  left join project_map_district on project_map_district.project_id =project.id      group by district_id) as ongoing on ongoing.district_id=mas_district.id  where mas_district.id=\"" . $base_id . "\"");
$results = $query->getResultArray();
foreach ($results as $row) {
    echo "                      <tr>\r\n                        <td>";
    echo $row["name"];
