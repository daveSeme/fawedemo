...
echo base_url();
echo "/public/img/logo-big.png\" alt=\"NEMA Logo\">\r\n       <h1 class=\"fs-xxl fw-700 color-fusion-500 d-flex align-items-center justify-content-center mt-4\"> \r\n       <span class=\"color-black-700\">Welcome to NEMA Web Based Monitoring & Evaluation Management Information System (M&E MIS)</span> \r\n      </h1>\r\n\t<p><h3>";
