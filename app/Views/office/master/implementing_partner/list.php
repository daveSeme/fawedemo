...
echo base_url() . "/master/implementing_partner/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("master/implementing_partner/delete/" . $record["id"]);
        ...
        echo base_url("master/implementing_partner/edit/" . $record["id"]);
