...
echo base_url() . "/master/subexecuting_partner/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo "<td>". $record["organization_name"] . "</td>";
        echo "<td>". $record["contact_person"] . "</td>";
        echo "<td>". $record["contact_email"] . "</td>";
        echo "<td><div class=\"d-flex demo\"> <a href=\"#\"  onClick=\"javascript:del_rec_1('";
        echo base_url("master/subexecuting_partner/delete/" . $record["id"]);
        ...
        echo base_url("master/subexecuting_partner/edit/" . $record["id"]);
