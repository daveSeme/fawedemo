...
if (set_value("user_type") == "NEMA User") {
...
echo "> Viewer</option>\r\n \t\t\t\t\t \r\n                    </select>\r\n                    <div class=\"invalid-feedback\"> Please select the User Type  </div>\r\n                  </div>\r\n\t\t\t\t\r\n\t\t\t\t<div class=\"col-12 mb-3\">\r\n                    <label class=\"form-label\" for=\"type\">Group Name<span class=\"text-danger\">*</span></label>\r\n                   <input type=\"text\" name=\"name\" class=\"form-control\" id=\"name\" placeholder=\"Please enter the group name\" value=\"";
echo set_value("name");
