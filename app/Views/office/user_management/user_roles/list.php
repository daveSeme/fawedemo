...
echo base_url() . "/user_management/user_roles/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("user_management/user_roles/delete/" . $record["id"]);
        ...
        echo base_url("user_management/user_roles/edit/" . $record["id"]);
