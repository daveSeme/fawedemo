...
echo $title;
echo "</h2>\r\n                \r\n";
$query_plan = $db->query("select * from project_quarterly_workplan_progress_reports where project = '" . $project . "' ");
...
if (!empty($results_plan)) {
    ...
    $query_mon_progress_report = $db->query("select * from project_quarterly_workplan_progress_reports_mapping where  workflow_id = '" . $row_plan->id . "' order by activity_id ");
