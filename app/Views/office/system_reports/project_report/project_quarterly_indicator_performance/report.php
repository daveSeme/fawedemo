...
if (!empty($results_plan)) {
    ...
    $query_mon_progress_report = $db->query("select * from project_quarterly_indicator_tracking_report_map where workflow_id = '" . $row_plan->id . "' and category = 'Component Indicator' order by indicator_id");
