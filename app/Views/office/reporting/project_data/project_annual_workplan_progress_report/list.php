...
echo base_url() . "/reporting/project_data/project_annual_workplan_progress_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("reporting/project_data/project_annual_workplan_progress_report/delete/" . $record["id"]);
        ...
        echo base_url("reporting/project_data/project_annual_workplan_progress_report/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n                   <a href=\"";
        echo base_url() . "/reporting/project_data/project_annual_workplan_progress_report/view/" . $record["id"];
