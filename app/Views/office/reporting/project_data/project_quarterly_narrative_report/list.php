...
echo base_url() . "/reporting/project_data/project_quarterly_narrative_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        if ($record["report_status"] == "1") {
            ...
            echo base_url("reporting/project_data/project_quarterly_narrative_report/delete/" . $record["id"]);
        ...
        if ($record["report_status"] == "1" || $record["report_status"] == "3") {
            ...
            echo base_url("reporting/project_data/project_quarterly_narrative_report/edit/" . $record["id"]);
            echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\r\n                    ";
        }
        echo "                    \r\n                    \t\r\n                   <a href=\"";
        echo base_url() . "/reporting/project_data/project_quarterly_narrative_report/view/" . $record["id"];
