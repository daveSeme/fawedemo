...
$insert_url = "reporting/project_data/project_semi_annual_workplan_progress_report/add";
...
if (set_value("quarter") == "Semi1") {
    echo "selected=\"selected\"";
}
echo " >Q1+Q2</option>\r\n                      <option value=\"Semi2\" ";
if (set_value("quarter") == "Semi2") {
    echo "selected=\"selected\"";
}
