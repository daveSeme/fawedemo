...
echo base_url() . "/reporting/project_data/project_semi_annual_workplan_progress_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        $project = get_by_id("id", $record["project"], "project");
        echo $project["name"];
        echo "</td>\r\n                     <td>";
        ...
        echo base_url("reporting/project_data/project_semi_annual_workplan_progress_report/delete/" . $record["id"]);
        ...
        echo base_url("reporting/project_data/project_semi_annual_workplan_progress_report/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n                   <a href=\"";
        echo base_url() . "/reporting/project_data/project_semi_annual_workplan_progress_report/view/" . $record["id"];
