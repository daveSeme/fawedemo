...
echo base_url() . "/reporting/project_data/beneficiaries_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo $record["year"];
        echo "</td>\r\n                    <td>";
        echo $record["reporting_period"];
        echo "</td>\r\n                    \r\n                    ";
        echo "<td>\r\n\t\t\t\t\t";
        $query = $db->query("select name FROM mas_county WHERE id = '" . $record["county"] . "'");
        ...
        echo base_url("reporting/project_data/beneficiaries_report/delete/" . $record["id"]);
        ...
        echo base_url("reporting/project_data/beneficiaries_report/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\t\r\n                   \r\n                   <a href=\"";
        echo base_url() . "/reporting/project_data/beneficiaries_report/view/" . $record["id"];
