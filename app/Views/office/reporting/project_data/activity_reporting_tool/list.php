...
echo base_url() . "/reporting/project_data/activity_reporting_tool/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        if ($record["report_status"] == "1") {
            ...
            echo base_url("reporting/project_data/activity_reporting_tool/delete/" . $record["id"]);
        ...
        if ($record["report_status"] == "1" || $record["report_status"] == "3") {
            ...
            echo base_url("reporting/project_data/activity_reporting_tool/edit/" . $record["id"]);
            echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\r\n                   ";
        }
        echo "                   \r\n                    \t\r\n                   <a href=\"";
        echo base_url() . "/reporting/project_data/activity_reporting_tool/view/" . $record["id"];
