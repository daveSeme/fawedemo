...
echo base_url() . "/reporting/project_data/project_semi_annual_narrative_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("reporting/project_data/project_semi_annual_narrative_report/delete/" . $record["id"]);
        ...
        echo base_url("reporting/project_data/project_semi_annual_narrative_report/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\t\r\n                   <a href=\"";
        echo base_url() . "/reporting/project_data/project_semi_annual_narrative_report/view/" . $record["id"];
