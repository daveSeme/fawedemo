...
$insert_url = "reporting/project_data/project_semi_annual_narrative_report/edit/" . $stdata["id"];
...
if ($stdata["quarter"] == "Q1+Q2") {
    echo "selected=\"selected\"";
}
echo " >Q1+Q2</option>\r\n                      <option value=\"Q3+Q4\" ";
if ($stdata["quarter"] == "Q3+Q4") {
    echo "selected=\"selected\"";
}
...
foreach ($results_file as $row_file) {
    ...
    echo "</a>                          \r\n                          </td>\r\n                          <td>\r\n                           <a href=\"";
    echo base_url("reporting/project_data/project_semi_annual_narrative_report/delete_docs/" . $row_file["id"] . "/" . $stdata["id"]);
