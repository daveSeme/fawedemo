...
$insert_url = "reporting/organizational_data/org_annual_indicator_tracking_report/edit/" . $stdata["id"];
...
$query_mon_progress_report = $db->query("select * from org_annual_indicator_tracking_report_map where workflow_id = '" . $stdata["id"] . "' and category = 'Objective Indicator' order by indicator_id");
