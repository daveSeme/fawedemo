...
echo base_url() . "/reporting/organizational_data/org_annual_indicator_tracking_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo base_url("reporting/organizational_data/org_annual_indicator_tracking_report/delete/" . $record["id"]);
        ...
        echo base_url("reporting/organizational_data/org_annual_indicator_tracking_report/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\t\r\n                   \r\n                   <a href=\"";
        echo base_url() . "/reporting/organizational_data/org_annual_indicator_tracking_report/view/" . $record["id"];
