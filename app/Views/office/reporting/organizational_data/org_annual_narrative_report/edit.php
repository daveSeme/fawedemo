...
$insert_url = "reporting/organizational_data/org_annual_narrative_report/edit/" . $stdata["id"];
...
foreach ($results_file as $row_file) {
    ...
    echo "</a>                          \r\n                          </td>\r\n                          <td>\r\n                           <a href=\"";
    echo base_url("reporting/organizational_data/org_annual_narrative_report/delete_docs/" . $row_file["id"] . "/" . $stdata["id"]);
