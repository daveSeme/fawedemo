...
echo $ip["name"];
echo "                        </td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td  class=\"form-label\">Age of Survivor </td>\r\n\t\t\t\t\t\t<td >";
echo $stdata["age_survivor"];
echo "</td>\r\n\t\t\t\t\t</tr>\r\n                    \r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td  class=\"form-label\">Gender </td>\r\n\t\t\t\t\t\t<td >";
echo $stdata["gender"];
echo "</td>\r\n\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t \r\n\t\t\t\t   \r\n                   \r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td  class=\"form-label\">Diversity Details</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t <table class=\"table table-bordered\">\r\n                           <thead>\r\n                            <tr bgcolor=\"#cccccc\">\r\n                                 <th>Diversity</th>\r\n                                 <th>Male</th>\r\n                                 <th>Female</th>\r\n                                 <th>Total </th>\r\n                           </tr>\r\n                           </thead>\r\n                           \r\n                           <tbody>\r\n                            <tr>\r\n                                 <td>";
echo $stdata["diversity"];
echo "</td>\r\n                                 <td>";
echo $stdata["diversity_male"];
echo "</td>\r\n                                 <td>";
echo $stdata["diversity_female"];
echo "</td>\r\n                                 <td>";
echo $stdata["diversity_male"] + $stdata["diversity_female"];
echo " </td>\r\n                           </tr>\r\n                           </tbody>\r\n                           \r\n                         </table>\r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t \r\n                        </td>\r\n\t\t\t\t\t</tr>\r\n                   \r\n                   \r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td  class=\"form-label\">Economic Status </td>\r\n\t\t\t\t\t\t<td >";
echo $stdata["economic_status"];
echo "</td>\r\n\t\t\t\t\t</tr>\r\n                   \r\n                   \r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td  class=\"form-label\">Place of Residence </td>\r\n\t\t\t\t\t\t<td >";
...
$row = $query->getRow();
echo $row->name;
echo "                        </td>\r\n\t\t\t\t\t</tr>\r\n                    \r\n                       \r\n\t\t\t\t\t<tr >\r\n\t\t\t\t\t  <td class=\"form-label\">Marital Status of Survivor</td>\r\n\t\t\t\t\t\t<td >";
echo $stdata["marital_status"];
echo "</td>\r\n\t\t\t\t   </tr>\r\n                   \r\n                    \r\n                    \r\n\t\t\t\t   <tr>\r\n                        <td class=\"form-label\">Type of GBV reported</td>\r\n                        <td >\r\n                        ";
$db = Config\Database::connect();
$query_reg = $db->query("select type_gbv FROM cases_map_type_gbv where workflow_id=\"" . $pid . "\" ");
