...
echo base_url() . "/reporting/organizational_data/org_quarterly_narrative_report/add";
...
if ($data) {
    ...
    foreach ($data as $record) {
        ...
        echo $record["quarter"];
        echo "</td>\r\n                            <td>";
        echo substr($record["key_highlights"], 0, 80) . "..........";
        echo "</td>\r\n                            <td>";
        echo substr($record["challenges_experienced"], 0, 80) . "..........";
        echo "</td>\r\n                            <td>";
        echo substr($record["success_stories"], 0, 80) . "..........";
        echo "</td>\r\n                            <td>";
        echo substr($record["activities_anticipated"], 0, 80) . "..........";
        echo "</td>\r\n                            \r\n                            <td>\r\n                            ";
        ...
        echo base_url("reporting/organizational_data/org_quarterly_narrative_report/delete/" . $record["id"]);
        ...
        echo base_url("reporting/organizational_data/org_quarterly_narrative_report/edit/" . $record["id"]);
        echo "')\" class=\"btn btn-sm btn-outline-primary btn-icon btn-inline-block mr-1\" title=\"Edit\"><i class=\"fal fa-edit\"></i></a>\t\r\n                   <a href=\"";
        echo base_url() . "/reporting/organizational_data/org_quarterly_narrative_report/view/" . $record["id"];
