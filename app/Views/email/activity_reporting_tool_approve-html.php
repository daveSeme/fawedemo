...
echo "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">\r\n<html>\r\n<head><title>Activity Reporting Submitted for Review has been Approved ";
echo $site_name;
...
echo $workflow_details["activity_title"];
echo " </p>\r\n<p><strong>Activity Date </strong> : ";
echo date("d/m/Y", strtotime($workflow_details["activity_date"]));
