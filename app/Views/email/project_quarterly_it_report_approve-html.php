...
echo "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">\r\n<html>\r\n<head><title>Quarterly Indicator Tracking Report Submitted for Review has been Approved ";
echo $site_name;
...
echo $subject;
echo "</h2>\r\n\r\n";
$workflow_details = get_by_id("id", $record_id, "project_quarterly_indicator_tracking_report");
...
echo "\r\n<p><strong>Report Details are :</strong></p><br>\r\n\r\n<p><strong>Project Name </strong> : ";
echo $project_name;
echo " </p>\r\n<p><strong>Reporting Period </strong> : ";
echo $workflow_details["year"] . "-" . $workflow_details["quarter"];
