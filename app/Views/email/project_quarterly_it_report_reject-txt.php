...
echo "Quarterly Indicator Tracking Report Submitted for Review has been Rejected ";
echo $site_name;
echo ",\r\n\r\n";
...
$the_message = $the_message . "Reporting Period \t: \t" . "\n" . $workflow_details["year"] . "-" . $workflow_details["quarter"] . "\n<br>";
