...
class Dimensions extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        if ($this->session->get("user_type") == "admin") {
            check_permision("dimensions", "1", 1);
        } else {
            check_permision("dimensions", "1", 0);
        }
    }
    public function index()
    {
        ...
        $data["js_file"] = "office/master/dimensions/js_file";
        $data["main_content"] = "office/master/dimensions/list";
