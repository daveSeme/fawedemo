        ...
        if ($this->request->getMethod() === "post") {
            ...
            if (count($results) <= 0) {
                if ($this->validate->withRequest($this->request)->run()) {
                    $postdata = ["base_id" => $this->session->get("office"), "project" => $this->request->getVar("project"), "year" => $this->request->getVar("year"), "reporting_period" => $this->request->getVar("reporting_period"), "county" => $this->request->getVar("county"), "type_beneficiaries" => $this->request->getVar("type_beneficiaries"), "indirect_beneficiaries" => $this->request->getVar("indirect_beneficiaries"), "pwds_male" => $this->request->getVar("pwds_male"), "pwds_female" => $this->request->getVar("pwds_female"), "lgbtq_male" => $this->request->getVar("lgbtq_male"), "lgbtq_female" => $this->request->getVar("lgbtq_female"), "age_0_to_17_male" => $this->request->getVar("age_0_to_17_male"), "age_0_to_17_female" => $this->request->getVar("age_0_to_17_female"), "age_18_to_24_male" => $this->request->getVar("age_18_to_24_male"), "age_18_to_24_female" => $this->request->getVar("age_18_to_24_female"), "age_25_to_49_male" => $this->request->getVar("age_25_to_49_male"), "age_25_to_49_female" => $this->request->getVar("age_25_to_49_female"), "age_50_plus_male" => $this->request->getVar("age_50_plus_male"), "age_50_plus_female" => $this->request->getVar("age_50_plus_female"), "createdby" => $data["user_id"], "createtime" => date("Y-m-d H:i:s")];
                    $model = new \App\Models\reporting\project_data\Beneficiaries_report_model();
