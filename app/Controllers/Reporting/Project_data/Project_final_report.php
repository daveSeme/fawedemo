...
class Project_final_report extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        check_permision("project_final_report", "1", 0);
    }
    public function index()
    {
        ...
        $data["title"] = "Project Final Evaluation Report";
        ...
        $data["js_file"] = "office/reporting/project_data/project_final_report/js_file";
        $data["main_content"] = "office/reporting/project_data/project_final_report/list";
        echo view("template/index", $data);
    }
    public function add()
    {
        check_permision("project_final_report", "2", 0);
        $data["user_id"] = $this->tank_auth->get_user_id();
        $data["username"] = $this->tank_auth->get_username();
        $data["user_level"] = $this->tank_auth->get_user_level();
        $data["title"] = "Add Project Final Evaluation Report";
        $data["main_title"] = "Program/Project Reports";
        $data["base_id"] = $this->session->get("office");
        if ($this->request->getMethod() === "post") {
            ...
            if ($this->validate->withRequest($this->request)->run()) {
                ...
                if ($this->request->getVar("action") == "save") {
                    return $this->response->redirect(site_url("reporting/project_data/project_final_report/add"));
                }
                return $this->response->redirect(site_url("reporting/project_data/project_final_report/"));
            }
            $data["validator"] = $this->validator;
        }
        $data["js_file"] = "office/reporting/project_data/project_final_report/js_file";
        $data["main_content"] = "office/reporting/project_data/project_final_report/add";
        echo view("template/index", $data);
    }
    public function edit($id = NULL)
    {
        check_permision("project_final_report", "4", 0);
        $data["user_id"] = $this->tank_auth->get_user_id();
        $data["username"] = $this->tank_auth->get_username();
        $data["user_level"] = $this->tank_auth->get_user_level();
        $data["title"] = "Add Project Final Evaluation Report";
        ...
        $data["js_file"] = "office/reporting/project_data/project_final_report/js_file";
        $data["main_content"] = "office/reporting/project_data/project_final_report/edit";
        echo view("template/index", $data);
    }
    public function delete($id = NULL)
    {
        check_permision("project_final_report", "3", 0);
        $model = new \App\Models\reporting\project_data\Final_report_model();
    ...
    public function view($id = NULL)
    {
        ...
        $data["username"] = $this->tank_auth->get_username();
        $data["user_level"] = $this->tank_auth->get_user_level();
        $data["title"] = "View Project Final Report";
        $data["main_title"] = "Programs/Project";
        $data["pid"] = $id;
        $model = new \App\Models\reporting\project_data\Final_report_model();
        $data["stdata"] = $model->where("id", $id)->first();
        $data["js_file"] = "office/reporting/project_data/project_final_report/js_file";
        $data["main_content"] = "office/reporting/project_data/project_final_report/view";
        echo view("template/index", $data);
    }
    public function download_excel()
    {
        ...
        $data["title"] = "Project Final Report";
        $model = new \App\Models\reporting\project_data\Final_report_model();
        $data["stdata"] = $model->where("id", $data["id"])->first();
        $data["filename"] = $data["title"] . "_" . date("d_m_Y_h_i_a") . ".xls";
        ob_start();
        echo view("office/reporting/project_data/project_final_report/export", $data);
        $table = ob_get_clean();
