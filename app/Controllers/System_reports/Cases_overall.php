...
class Cases_overall extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        check_permision("cases_overall", "1", 0);
    }
    public function index()
    {
        ...
        $data["title"] = "Cases Database Report – National";
        ...
        $data["js_file"] = "office/system_reports/cases_report/cases_overall/js_file";
        $data["main_content"] = "office/system_reports/cases_report/cases_overall/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/cases_report/cases_overall/export", $data);
        $table = ob_get_clean();
