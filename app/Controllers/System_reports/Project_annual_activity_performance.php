...
class Project_annual_activity_performance extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        check_permision("project_annual_activity_performance", "1", 0);
    }
    public function index()
    {
        ...
        $data["title"] = "Project Annual Activity Performance Report";
        ...
        $data["js_file"] = "office/system_reports/project_report/project_annual_activity_performance/js_file";
        $data["main_content"] = "office/system_reports/project_report/project_annual_activity_performance/list";
    ...
    public function download_excel()
    {
        ...
        $data["title"] = "Project Annual Indicator Performance Report";
        ...
        ob_start();
        echo view("office/system_reports/project_report/project_annual_activity_performance/export", $data);
        $table = ob_get_clean();
