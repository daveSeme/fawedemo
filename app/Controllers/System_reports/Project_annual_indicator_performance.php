...
class Project_annual_indicator_performance extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        check_permision("project_annual_indicator_performance", "1", 0);
    }
    public function index()
    {
        ...
        $data["js_file"] = "office/system_reports/project_report/project_annual_indicator_performance/js_file";
        $data["main_content"] = "office/system_reports/project_report/project_annual_indicator_performance/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/project_report/project_annual_indicator_performance/export", $data);
        $table = ob_get_clean();
