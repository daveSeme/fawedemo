...
class beneficiaries_report_county extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data["js_file"] = "office/system_reports/beneficiaries_report/beneficiaries_report_county/js_file";
        $data["main_content"] = "office/system_reports/beneficiaries_report/beneficiaries_report_county/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/beneficiaries_report/beneficiaries_report_county/export", $data);
        $table = ob_get_clean();
