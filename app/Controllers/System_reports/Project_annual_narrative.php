...
class Project_annual_narrative extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data["js_file"] = "office/system_reports/project_report/project_annual_narrative/js_file";
        $data["main_content"] = "office/system_reports/project_report/project_annual_narrative/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/project_report/project_annual_narrative/export", $data);
        $table = ob_get_clean();
