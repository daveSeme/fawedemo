...
class Project_quarterly_activity_performance extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        check_permision("project_quarterly_activity_performance", "1", 0);
    }
    public function index()
    {
        ...
        $data["title"] = "Project Quarterly Activity Performance Report";
        ...
        $data["js_file"] = "office/system_reports/project_report/project_quarterly_activity_performance/js_file";
        $data["main_content"] = "office/system_reports/project_report/project_quarterly_activity_performance/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/project_report/project_quarterly_activity_performance/export", $data);
        $table = ob_get_clean();
