...
class Beneficiaries_report_national extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data["title"] = "Beneficiaries Report National";
        ...
        $data["js_file"] = "office/system_reports/beneficiaries_report/beneficiaries_report_national/js_file";
        $data["main_content"] = "office/system_reports/beneficiaries_report/beneficiaries_report_national/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/beneficiaries_report/beneficiaries_report_national/export", $data);
        $table = ob_get_clean();
