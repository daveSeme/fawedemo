...
class Project_schedule extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        check_permision("project_schedule", "1", 0);
    }
    public function index()
    {
        ...
        $data["title"] = "Project Schedule Report";
        ...
        $data["js_file"] = "office/system_reports/project_report/project_schedule/js_file";
        $data["main_content"] = "office/system_reports/project_report/project_schedule/list";
    ...
    public function download_excel()
    {
        ...
        ob_start();
        echo view("office/system_reports/project_report/project_schedule/export", $data);
        $table = ob_get_clean();
